...
public class CalibratorBlock extends AbstractRedstoneGateBlock implements BlockEntityProvider {
    ...
    /**
     * Updates the BlockState for powered-ness, updates blockentity power level & updates target
     */
    ...
    /**
     * This attempts to compute the target output redstone signal strength for a given "activation"
     */
